...
import { TutorialBlockService, TutorialCategoryService, TutorialReadService, TutorialService } from './services';
...
@Module({
  ...
  providers: [TutorialCategoryService, TutorialService, TutorialBlockService, TutorialReadService],
  imports: [TypeOrmModule.forFeature([Tutorial, TutorialCategory, TutorialBlock]), FilesModule],
  exports: [TutorialReadService],
})
